  ...
  fetch(indexURL)
    ...
    .then(data => {
      ...
      if (result.length > 0) {
        ...
        document.querySelector('#search-results').innerHTML = '<div class=\"text-center\"><img class=\"img-fluid mb-5\" src=\"https://user-images.githubusercontent.com/17677384/122171726-dabfee00-cea1-11eb-9f7f-b75b5c967205.png\" width=\"300\"><h3>No Search Found</h3></div>'
      }
    });
}
