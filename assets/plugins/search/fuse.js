...
e = this, t = function () {
  ...
  function _(e) {
    ...
    if (g(e) || v(e)) r = e, t = O(e), n = j(e);
      ...
      if (!S.call(e, "name")) throw new Error(function (e) {
        return "Missing ".concat(e, " property in key")
      }("name"));
      var o = e.name;
      if (r = o, S.call(e, "weight") && (i = e.weight) <= 0) throw new Error(function (e) {
  ...
  var E = function () {
    function e() {
      ...
      t(this, e), this.norm = C(3), this.getFn = i, this.isCreated = !1, this.setIndexRecords()
    }
    return r(e, [{
      key: "setSources",
      value: function () {
  ...
  function F() {
    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : A.minMatchCharLength, n = [], r = -1, i = -1, o = 0, c = e.length; o < c; o += 1) {
      var a = e[o];
  ...
  var N = function () {
      function e(n) {
        ...
        if (t(this, e), this.options = {
          ...
          if (x > 32) {
            for (var L = 0, S = x % 32, w = x - S; L < w;) b(this.pattern.substr(L, 32), L), L += 32;
            if (S) {
              var _ = x - 32;
          ...
          this.chunks.forEach((function (t) {
            var n = t.pattern,
              ...
              y = function (e, t, n) {
                ...
                for (var m, k = t.length, M = e.length, b = Math.max(0, Math.min(o, M)), x = u, S = b, w = d > 1 || g, _ = w ? Array(M) : [];
                  (m = e.indexOf(t, S)) > -1;) {
                  var O = R(t, {
                    currentLocation: m,
                    expectedLocation: b,
                ...
                for (var I = [], C = 1, E = k + M, $ = 1 << k - 1, P = 0; P < k; P += 1) {
                  ...
                  for (var J = q; J >= K; J -= 1) {
                    var T = J - 1,
                      U = n[e.charAt(T)];
                    if (w && (_[T] = +!!U), W[J] = (W[J + 1] << 1 | 1) & U, P && (W[J] |= (I[J + 1] | I[J]) << 1 | 1 | I[J + 1]), W[J] & $ && (C = R(t, {
                        errors: P,
                        currentLocation: T,
                        expectedLocation: b,
                        distance: a,
  ...
  var K = function (e) {
    ...
    V = function (e) {
      ...
      function i(e) {
        ...
        return t(this, i), (r = n.call(this, e))._bitapSearch = new N(e, {
          location: a,
          threshold: u,
          distance: f,
          includeMatches: d,
    ...
    Z = function () {
      function e(n) {
        ...
        t(this, e), this.query = null, this.options = {
          ...
          threshold: p,
          distance: k
        }, this.pattern = o ? n : n.toLowerCase(), this.query = X(this.pattern, this.options)
      }
      return r(e, [{
        key: "searchIn",
        value: function (e) {
  ...
  var ne = "$and",
    ...
    ue = function (e) {
      return i({}, ne, Object.keys(e).map((function (t) {
        return i({}, t, e[t])
      })))
    };
  ...
  function fe(e, t) {
    var n = e.matches;
    t.matches = [], k(n) && n.forEach((function (e) {
  ...
  function de(e, t) {
    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
      ...
      a = [];
    return i && a.push(fe), c && a.push(le), e.map((function (e) {
      var n = e.idx,
        r = {
          item: t[n],
          refIndex: n
  ...
  var ve = function () {
    function e(n) {
      ...
      t(this, e), this.options = c({}, A, {}, r), this.options.useExtendedSearch, this._keyStore = new w(this.options.keys), this.setCollection(n, i)
    }
    return r(e, [{
      key: "setCollection",
      value: function (e, t) {
        if (this._docs = e, t && !(t instanceof E)) throw new Error("Incorrect 'index' type");
        this._myIndex = t || $(this.options.keys, this._docs, {
      ...
      value: function (e) {
        ...
        return he(h, {
          ignoreFieldNorm: u
        }), a && h.sort(s), y(r) && r > -1 && (h = h.slice(0, r)), de(h, this._docs, {
          includeMatches: o,
          includeScore: c
        })
      }
        ...
        return r.forEach((function (e) {
          ...
          if (k(r)) {
            ...
            a.length && (i[c] || (i[c] = {
              ...
              item: r,
              matches: []
            }, o.push(i[c])), a.forEach((function (e) {
              var t, n = e.matches;
        ...
        return o.forEach((function (e) {
          ...
          if (k(r)) {
            ...
            i.forEach((function (e, i) {
              a.push.apply(a, l(t._findMatches({
                key: e,
                value: r[i],
                searcher: n
              })))
  ...
  return ve.version = "6.4.6", ve.createIndex = $, ve.parseIndex = function (e) {
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        n = t.getFn,
